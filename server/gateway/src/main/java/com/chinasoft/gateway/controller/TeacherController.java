...
import com.chinasoft.gateway.service.TeacherService;
...
public class TeacherController {
     ...
     *
     * **/
    @ApiOperation(value="教师中心微服务", notes="教师中心微服务")
    @ApiImplicitParam(name = "request", value = "请求信息，具体参见微服务接口协议", required = true, dataType = "RequestVO")
    @RequestMapping(value="/teacher-service",method = RequestMethod.POST)
    public ResponseVO teacherService(@RequestBody RequestVO request,HttpSession session){
        ...
        responseVO = teacherService.invokeRestService(teacherService.getUrl(request),request.getInput());
